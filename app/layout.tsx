            ...
            <div className="h-20 max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0">
                ...
                {process.env.NODE_ENV !== "production" && (
                  <Link
                    href="/recipes/new"
                    className="flex items-center gap-1.5 bg-[#1a130e] hover:bg-[#001ec0] text-white px-3 sm:px-3.5 py-2 font-mono text-xs uppercase tracking-wider font-semibold transition-all shadow-[0_2px_0_#1A130E] active:translate-y-0.5"
                  >
