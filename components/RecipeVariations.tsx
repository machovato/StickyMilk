  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3">
        {variations.map((v, i) => {
          const recipeHref = `/recipes/${v.slug}`;
          return (
            <div
              key={i}
            ...
            >
              ...
              <div className="flex flex-col justify-between flex-1 min-w-0 py-0.5">
                <div className="flex flex-col gap-1">
                  <div className="flex items-center gap-1.5 font-mono text-[10px] text-[#7f756f] truncate">
                    {v.creator.avatar && (
                      <img
                        src={v.creator.avatar}
                        alt={v.creator.name}
                        className="w-3.5 h-3.5 rounded-full object-cover border border-[#1a130e]/20 flex-shrink-0"
                      />
                    )}
